...
public class SandboxArreglos
{
    ...
    public void eliminarEntero( int valor )
    {
        ...
        int[] nuevoArreglo = new int[arregloEnteros.length - cantidadEliminados];
    ...
    public void eliminarCadena( String cadena )
    {
    	...
    	arregloCadenas = listaNueva.toArray(new String[0]);
    }
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
    	...
    	HashMap<Integer, Integer> frecuenciaArreglo1 = new HashMap<>();
        HashMap<Integer, Integer> frecuenciaArreglo2 = new HashMap<>();
        
        for (int valor : arregloEnteros) {
            frecuenciaArreglo1.put(valor, frecuenciaArreglo1.getOrDefault(valor, 0) + 1);
        }
        
        for (int valor : otroArreglo) {
            frecuenciaArreglo2.put(valor, frecuenciaArreglo2.getOrDefault(valor, 0) + 1);
        }
        return frecuenciaArreglo1.equals(frecuenciaArreglo2);
    }
