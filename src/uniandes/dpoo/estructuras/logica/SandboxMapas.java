...
public class SandboxMapas
{
    ...
    public List<String> getValoresComoLista( )
    {
        ...
        valoresOrdenados.sort(String::compareTo); 
    ...
    public List<String> getLlavesComoListaInvertida( )
    {
        ...
        Collections.sort(llavesOrdenadas, Collections.reverseOrder());
    ...
    public String getUltima( )
    {
        ...
        return mapaCadenas.values().stream().max(String::compareTo).get();
    }
    ...
    {
    	Map<String, Long> conteoPorValor = mapaCadenas.values().stream().collect(Collectors.groupingBy(Object::toString, Collectors.counting()));
    	int cantidadValoresUnicos = conteoPorValor.size();
        return cantidadValoresUnicos;
    }
